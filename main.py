...
HOST_OUTPUT_FILE = "bad_motherfuckerz_host.txt"
...
def main():
    ...
    # Write HOSTS format output
    host_format_list = [f"0.0.0.0 {item}" for item in final_list]
    write_output_file(HOST_OUTPUT_FILE, host_format_list)
